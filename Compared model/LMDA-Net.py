...
class LMDA(nn.Module):
    ...
    def __init__(self, chans=22, samples=1125, num_classes=4, depth=9, kernel=75, channel_depth1=24, channel_depth2=9,
        ...
        self.channel_weight = nn.Parameter(torch.randn(depth, 1, chans), requires_grad=True)  # 9,1,3
        nn.init.xavier_uniform_(self.channel_weight.data)  # 初始化权重
    ...
    def forward(self, x):
        x = torch.einsum('bdcw, hdc->bhcw', x, self.channel_weight)     # 12，1，3，875        9，1，3
