...
class Feature_extract(nn.Module):
    def __init__(self, chans=22, samples=1000, dropout_rate=0.5, F1=10, F2=40):
        super().__init__()
...
class Start():
    def __init__(self, nsub):
        ...
        self.nSub = nsub
        self.start_epoch = 0
        self.root = '/Dataset/standard_2a_data/'
        ...
        for e in range(self.n_epochs):
            ...
            # test model
                if (e + 1) % 1 == 0:
                    ...
                    test_kappa = cohen_kappa_score(test_label_np, y_pred_np)  # 添加Kappa计算
